...
hush
v0 $ fast 2 $ meta (pt ">1%4 id - *//2 la1%2 id") $ pe0 "_bd _sn"
v1 $ meta (ptm "*3%2 (g1) (s1.4,g0.8)")
  $ meta (ptm "/8 [*2 shh la1%4] fa2 id [fa2 | ea1%4]")
  $ meta (pt "id - *//2 ea1%2 id") $ pe0 "<1%4 *2 _mt,g0.8 - *2 _hc"

hush
v0 $ meta (pt "<1%2 [id - *//2 ea1%4 id]") $ pe0 "_bd _sn"
v1 $ early (1/4) $ slow 2
  $ pe "_lt _hc" &* pe0 "*4 s1,1:1 [*//2 s1 _] [*//3 s1 _ _]"
v2 $ pe "_bottle" &* pe0 "*4 s1,1:1 [*//2 s1 _] [*//3 s1 _ _]"
                  &* pe "/2 s0.7,1g0.8 s1" -- gain b/c slow one is loud
