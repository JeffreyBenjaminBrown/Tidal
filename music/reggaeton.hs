...
v5 $ early 1 $ sax &* (syParams $ meta g $ scales <*> late 1 saxline) &* pe "*3 f1.5 f0.5 f1.5 - *//2 f0.5 f0.75"
v1 shh
...
v5 $ meta (cata 1 [id,fast 2]) canline &* can
v6 $ early 1 $ sax &* (syParams $ meta g $ scales <*> late 1 saxline) &* pe "*3 f1.5 f2 f1.5 - *//2 f1.5 f3" &* pe "ff0.5 ff2 ff5"
